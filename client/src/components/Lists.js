    ...
    <div className="lists-container">
      ...
      {lists.length === 0 ? (
        <div className="no-data">
          <p>
            No lists uploaded yet. Upload your first CSV file to get started.
          </p>
        </div>
      ) : (
          ...
          {lists.map((list) => (
            <div key={list._id} className="list-card">
              ...
              <div className="list-meta">
                <span>
                  <strong>Total Items:</strong> {list.totalItems}
                </span>
                <span>
                  <strong>Uploaded:</strong> {formatDate(list.createdAt)}
                </span>
                <span>
                  <strong>Agents:</strong> {list.distributions?.length || 0}
                </span>
              </div>
